...
def retrieve_contents(filename: str):
...
def retrieve_conversion_rates(currencies: list[str]):
...
def normalize_clients(clients: list[str]):
...
def retrieve_transactions(clients_filename: str, currency_filename: str, amount_filename: str):
